...
> a) JavaScript chạy ở đâu? (Trình duyệt / Server / Cả hai?)Trong trình duyệt: dùng để tạo tương tác cho trang web.
...
Xin chào, mình là Hoang dz, năm nay mình 22 tuổi.
...
> - Em gặp lỗi cú pháp nào? Em đã xử lý bằng cách nào (tự sửa, hỏi bạn, đọc lỗi, tìm Google, …)?...Em gặp lỗi khai báo lại biến (redeclaration of let age) khi sử dụng let nhiều lần cho cùng một biến... ...em tìm chat genimi...
...
> - Ưu điểm của việc dùng hàm thay vì lặp lại cùng một đoạn code nhiều lần là gì? Giúp tái sử dụng code nhiều lần làm chương trình ngắn gọn và dễ hiểu hơn, dễ sửa lỗi và bảo trì khi cần thay đổi chương trình.
...
> - Em đã làm gì để vượt qua (thử nhiều lần, hỏi bạn, xem lại ví dụ, tra Google, …)?  ...Em đã chạy thử nhiều lần trên console, thay đổi giá trị biến để xem kết quả, đọc lại ví dụ trong bài và tìm thêm trên Google để hiểu cách hoạt động của if/else và hàm trong JavaScript...
...
> Câu hỏi:
> - `document.getElementById("status")` đang làm gì?  ...Lệnh này dùng để tìm và lấy phần tử HTML có id là "status" trong trang web để JavaScript có thể thay đổi nội dung hoặc kiểu dáng của nó...
> - Sự kiện `"click"` xảy ra khi nào?  ...Sự kiện click xảy ra khi người dùng nhấn chuột vào một phần tử, ví dụ như nút bấm (button) trên trang web...
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang?  ...Khi nhấn nút btnHello, nội dung của đoạn văn có id status sẽ được thay đổi thành:Xin chào! Đây là nội dung được thay đổi bằng JavaScript...
...
> Câu hỏi:
> - Em có thể đổi sang màu khác (vd. `lightblue`) không?..Em có.. Hãy thử.
> - Em hãy ghi lại 1 ví dụ khác mà JavaScript có thể làm với `document.body.style`.  ...document.body.style.color = "blue";...
...
![alt text](<Screenshot 2026-03-05 163912.png>)
2. Sau khi nhấn “Chào”.
![alt text](image.png)
